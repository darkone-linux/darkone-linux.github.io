...
const $$LanguageSelect = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${starlightConfig.isMultilingual}${renderScript($$result, "/home/darkone/src/nixos-conf/doc/node_modules/@astrojs/starlight/components/LanguageSelect.astro?astro&type=script&index=0&lang.ts")}`;
...
const logos = { dark: __ASTRO_IMAGE_IMPORT_Z26UXhl, light: __ASTRO_IMAGE_IMPORT_Z26UXhl };
