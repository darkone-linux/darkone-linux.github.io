...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_2-dkPZoT.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_B6Fza0Kp.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://darkone-linux.github.io", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_D2gHwwbx.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BgAQfi4n.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DtSGq7Pr.mjs');
...
const starlightConfig = {"logo":{"src":"./src/assets/nix-logo.svg","alt":"","replacesTitle":false},"social":[{"icon":"github","label":"GitHub","href":"https://github.com/darkone-linux/darkone-nixos-framework"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Documentation","translations":{},"collapsed":false,"autogenerate":{"directory":"doc","attrs":{}}},{"label":"References","translations":{},"collapsed":false,"autogenerate":{"directory":"ref","attrs":{}}},{"label":"Changelog","translations":{},"slug":"changelog","attrs":{}},{"label":"Thanks!","translations":{},"slug":"thanks","attrs":{}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Darkone NixOS Framework"},"isMultilingual":true,"defaultLocale":{"label":"English","lang":"en","dir":"ltr","locale":"en"},"locales":{"en":{"label":"English","lang":"en","dir":"ltr"},"fr":{"label":"Français","lang":"fr","dir":"ltr"}}};

const project = {"build":{"format":"directory"},"root":"file:///home/darkone/src/nixos-conf/doc/","srcDir":"file:///home/darkone/src/nixos-conf/doc/src/","trailingSlash":"always"};
